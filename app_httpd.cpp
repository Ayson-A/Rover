...
.slider-container {
  ...
  margin: 0;
        ...
        <section class="main">
          <section id="buttons">
                ...
                <div id="controls" class="control-container">
                  ...
                  <tr><td></td><td align="center"><button class="button button2" id="forward" onclick="fetch('http://192.168.4.2/move?direction=forward')">↑</button></td><td></td></tr>
                  <tr><td align="center"><button class="button button2" id="turnleft" onclick="fetch('http://192.168.4.2/move?direction=left')">←</button></td><td align="center"><button class="button button2" id="stop" onclick="fetch('http://192.168.4.2/move?direction=stop')">■</button></td><td align="center"></td><td align="center"><button class="button button2" id="turnright" onclick="fetch('http://192.168.4.2/move?direction=right')">→</button></td></tr>
                  <tr><td></td><td align="center"><button class="button button2" id="backward" onclick="fetch('http://192.168.4.2/move?direction=reverse')">↓</button></td><td></td></tr>
                  </table>
                </div>
          </section>
          <figure>
    ...
    <br>
               ...
               <br>
                <div id="sliders" class="slider-container">
                  ...
                  <tr><td>Pan:</td><td align="center" colspan="2"><input type="range" id="PanServo" min="0" max="180" value="90" oninput="fetch('http://192.168.4.2/servo?joint=pan&value=' + this.value)"></td></tr>
                  <tr><td>Base:</td><td align="center" colspan="2"><input type="range" id="BaseServo" min="0" max="180" value="90" oninput="fetch('http://192.168.4.2/servo?joint=base&value=' + this.value)"></td></tr>
                  <tr><td>Shoulder:</td><td align="center" colspan="2"><input type="range" id="ShoulderServo" min="0" max="180" value="90" oninput="fetch('http://192.168.4.2/servo?joint=shoulder&value=' + this.value)"></td></tr>
                  <tr><td>Elbow:</td><td align="center" colspan="2"><input type="range" id="ElbowServo" min="0" max="180" value="90" oninput="fetch('http://192.168.4.2/servo?joint=elbow&value=' + this.value)"></td></tr>
                  <tr><td>Gripper:</td><td align="center" colspan="2"><input type="range" id="GripperServo" min="0" max="180" value="90" oninput="fetch('http://192.168.4.2/servo?joint=gripper&value=' + this.value)"></td></tr>
                  </table>
                </div>       
        </section>
        <script>
    ...
    const j = document.getElementById("stream"),
        ...
        q = () => {
            (j.src = `${c + ":81"}/stream`), f(k), (m.innerHTML = "Stop");
        };
    (l.onclick = () => {
